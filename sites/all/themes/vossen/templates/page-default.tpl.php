...
<div class="site-wrapper">
	...
	<div class="main-content-1">
      ...
      <!-- Onepage Title -->
 <div class="<?php if ($page['sidebar']): ?> col-m-12 <?php else: ?> col-md-12 <?php endif; ?>">                       
                  
     
    <div class="col-md-12"> <?php print render($page['help']); ?>
			<?php if ($action_links): ?>
   ...
   <!-- /.container, /#features -->
                        <?php endif; ?>
                            ...
                            <?php if ($page['sidebar']): ?>
                        <div class="container"><p class="sidebar-title white">Filter by Catergory Type:</p></div>
							
								<div class="col-md-1"><?php print render($page['sidebar']); ?></div>
							 <!-- /.sidebar -->
						<?php endif; ?>  </div>                     						
...
<!-- Onepage Call to Action 1 -->
      <?php if ($page['onepage_calltoaction1']): ?>
        <section id="call-to-action-2" class="">
	<div class="container">
